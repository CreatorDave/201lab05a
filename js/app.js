...
function sumArray(sumArr) { //eslint-disable-line
 ...
 let secondSum = sum(firstSum, sumArr[2])[0];
 
 let strTestSumArray = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${secondSum} is their sum.`
 
 return [secondSum, strTestSumArray]
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    let strMultiplyArray = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${secondProduct}.`

    return [secondProduct, strMultiplyArray]
}
